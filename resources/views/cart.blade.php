...
<div class="w-full h-full flex items-start justify-center min-h-[80vh] bg-white pb-20">
    <div class="container flex items-start justify-between flex-col md:flex-row">
        {{-- package and magazine list  --}}
        <div class="w-full md:w-2/3 lg:w-4/7">
                        ...
                        @foreach($magazineIds as $magazineId)
                            ...
                            <div class="flex items-start justify-start gap-2 flex-col md:flex-row my-3 mag_{{$magazine->id}}_remove">
                                ...
                                <div class="flex-1 flex flex-col justify-start gap-5 h-[200px]">
                                    ...
                                    <button onclick="removeCart('{{$package->id}}','{{$magazine->id}}')" class="rounded-md px-3 py-1 text-center text-white cursor-pointer bg-red-400 w-[100px]">Remove</button>
                                </div>
                            </div>
                        @endforeach
        ...
        {{-- cart summary --}}
        <div class="w-full md:w-1/3 lg:w-3/7">
