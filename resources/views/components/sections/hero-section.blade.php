<!-- hero section  -->
<section class="w-full bg-[#1B0000] text-white min-h-[70%]" >
    <div class="w-full flex bg-[#1B0000] h-auto lg:h-screen lg:overflow-y-auto text-white flex-col lg:flex-row pb-7 px-3">
        <div class="w-full lg:w-1/2 flex items-center justify-center pl-0 md:pl-6 lg:pl-8">
            <div class="w-full max-w-[700px] md:py-3 px-2 lg:px-5" data-aos="fade-left">
                ...
                <p class="mb-6 text-xl ">Gilded Vice is more than an experience—it’s your awakening.</p>
                <p class="text-gray-300 text-xl">From the whisper of silk against your skin to the
                    intoxicating pull of restraint, every detail draws you into a realm where control and surrender
                    entwine. </p>
                <p class="text-white mt-6 text-xl text-normal">Here, your deepest cravings aren’t just
        ...
        <div class="w-full lg:w-1/2 flex flex-col md:flex-row items-start h-auto relative">
            <img src="{{ asset('images/14.png') }}" data-aos="fade-right" loading="lazy" alt="Hero Image" class="w-full h-full md:max-h-[775px] lg:max-h-[90%] object-cover object-center rounded-md mt-3">
        </div>
    </div>

    <!-- Demo slider -->
    <h2 class="text-xl md:text-2xl text-center text-red-600 my-6 uppercase px-5" data-aos="fade-up">The Worlds Only BDSM Magazine That You Can Hear <span class="text-white">- And Listen To</span></h2>
    ...
    <div class="w-full max-w-5xl mx-auto px-2 md:px-6 lg:px-10 my-8">
        <div class="w-full grid gap-5 mx-auto md:grid-cols-2 lg:grid-cols-3 px-2">
            @foreach([
                ...
                <div class="flex items-start gap-2" data-aos="zoom-in">
    ...
    <div class="w-full flex bg-[#1B0000] text-white min-h-screen flex-col lg:flex-row px-3 pt-8 pb-20">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center lg:justify-start p-2 md:p-8">
            <div class="w-full md:p-4 max-w-[700px]" data-aos="fade-right">
