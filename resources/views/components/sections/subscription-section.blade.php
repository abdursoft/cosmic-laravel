<section class="w-full bg-[#FBF2DA] text-white py-20 px-4 md:px-5 lg:px-45">
    <div class="flex mt-5 w-full md:min-h-[77vh] flex-col md:flex-row flex-wrap">
        @foreach($packages as $key=>$package)
            <div class="w-full h-full @if($key < 3) md:w-1/3 h-[469px] @else md:w-1/2 h-[700px] @endif" data-aos="zoom-in">
                <div class="w-full h-full h-md relative text-gray-800 p-3">
                    <img src="x{{Storage::url($package->thumbnail)}}" alt="" class="w-full bg-white h-[350px] md:h-[550px] rounded-[22px] object-cover">
...
<div class="w-full bg-white py-20 md:px-24">
    <div class="w-full flex flex-col items-center justify-center" data-aos="fade-up">
        ...
        <img src="{{asset('images/features.png')}}" class="w-full rounded-[10px] max-w-4xl h-[86vh]" alt="">
    </div>
</div>
