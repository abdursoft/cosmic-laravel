{{-- auth modal  --}}
<div class="fixed auth-modal w-full h-screen top-0 left-0 bg-[rgba(0,0,0,0.5)] items-center justify-center"
    style="display: none;">
    <div class="w-full md:max-w-[45vw] bg-white rounded-md min-h-[40vh] p-3">
        <div class="flex items-center justify-between mb-5">
            <h1 class="text-base md:text-xl">Sign in or create a guilded account</h1>
