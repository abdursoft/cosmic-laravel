...
<div class="w-full flex justify-start flex-col gap-3 pt-5 pb-10">
    <div class="w-full rounded-md shadow-md flex items-center justify-center flex-col h-[430px] bg-white p-3">
        <img src="" class="w-full !h-[350px] rounded-md shadow-lg" alt="">
        <h3 class="text-xl md:text-2xl md:font-bold text-slate-800">00</h3>
        <p class="text-xl text-slate-800">Subscriptions</p>
    </div>
</div>
