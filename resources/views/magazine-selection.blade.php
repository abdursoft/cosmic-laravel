                        ...
                        <div class="flex flex-col p-5 w-full md:w-1/3">
                            <div class="w-full h-full rounded-lg overflow-hidden shadow-2xl flex flex-col">
                                ...
                                <div class="flex items-center justify-center flex-1 bg-gray-700 p-2 gap-3">
                                    <button type="button" onclick="addToCart('{{$magazine->id}}',this)" class="flex items-center justify-center gap-3 bg-orange-500 text-white rounded-md cursor-pointer w-full p-2">
...
<script>
    ...
    async function addToCart(id, el = null) {
        try {
            ...
            await sweetMessage('success', 'Added to cart', res.data.message);
